...
int main(int argc, char** argv) {
    if (argc != 2) {
        std::cout << "Usage: ./load_fmnist <path_to_mnist_data>" << std::endl;
        return -1;
    }
    ...
    FMNISTDataSet mnist_trainind_data;
    mnist_trainind_data.ReadFMNISTData(data_path / "train-images-idx3-ubyte", data_path / "train-labels-idx1-ubyte");

    FMNISTDataSet mnist_validation_data;
    mnist_validation_data.ReadFMNISTData(data_path / "t10k-images-idx3-ubyte", data_path / "t10k-labels-idx1-ubyte");
